															...
															<form action="/admin/pengumuman/{{$row->id}}" method="POST" enctype="multipart/form-data">
																...
																<div class="row">
																	...
																	<div class="col-md-6 pr-0">
																		<div class="form-group form-group-default">
																			<label>Narasi</label>
																			<input id="addPosition" type="text" name="narasi" value="{{ $row->judul}}" class="form-control" placeholder="fill position">
																		</div>
																	</div>
																	<div class="col-md-6">
																		<div class="form-group form-group-default">
																			<label>Foto</label>
																			<input id="addOffice" type="file" name="foto" value="{{ $row->judul}}" class="form-control" placeholder="fill office">
																		</div>
																	</div>
																</div>
																<div class="modal-footer no-bd">
