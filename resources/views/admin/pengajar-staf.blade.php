							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										...
										<a href="/tambahpengajar" class="btn btn-primary btn-round ml-auto" style="background: #04a3b1!important;border-color:#04a3b1!important;" data-toggle="modal" data-target="#addRowModal">
														...
														<div class="row">
															...
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	<label>Nama</label>
																	<input id="addName" type="text" name="nama" class="form-control" placeholder="fill name">
																</div>
															</div>
															...
															<div class="col-md-6">
																<div class="form-group form-group-default">
																	...
																	<input id="addOffice" type="text" name="mapel" class="form-control" placeholder="fill office">
																</div>
															</div>
														</div>
														<div class="modal-footer no-bd">
															<button type="submit" id="addRowButton" style="background: #04a3b1!important" class="btn btn-primary" >Add</button>
										...
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												...
												<tr>
													...
													<td>{{ $row->nama }}</td>
													<td>
														<img src="{{ asset('file/Pengajar/' . $row->foto) }}" width="150" height="100" alt="">
													</td>
													<td>{{ $row->mapel }}</td>
													<td>
														<div class="form-button-action">
															...
															<a href="/admin/pengajar-staf/delete/{{ $row->id }}">
																...
																<form action="/admin/pengajar-staf/{{$row->id}}" method="POST" enctype="multipart/form-data">
																	...
																	<div class="row">
																		...
																		<div class="col-md-6">
																			<div class="form-group form-group-default">
																				<label>Mata Pelajaran</label>
																				<input type="text" name="mapel" value="{{ $row->mapel }}" class="form-control">
																			</div>
																		</div>
																	</div>
																	<div class="modal-footer no-bd">
