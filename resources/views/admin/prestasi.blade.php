															...
															<div class="row">
																<div class="col-sm-12">
																	<div class="form-floating mb-2">
																		<label>Juara</label>
																		<input name="juara" type="text" class="form-control" required>
																	</div>
																</div>
																<div class="col-md-12">
																	<div class="form-floating mb-2">
												...
												<tr>
													...
													<td>
														<div class="form-button-action">
															...
															<a href="#">
																<button type="button" data-toggle="tooltip" class="btn btn-link btn-danger btn-lg delete" data-id="{{ $row->id }}" data-jenis="{{ $row->jenis }}">
																	...
																	<form action="/admin/prestasi/{{$row->id}}" method="POST" enctype="multipart/form-data">
																		...
																		<div class="row">
																			<div class="col-sm-12">
																				<div class="form-floating mb-2">
																					<label>Juara</label>
																					<input name="juara" value="{{$row->juara}}" type="text" class="form-control" required>
																				</div>
																			</div>
																			<div class="col-md-12">
																				<div class="form-floating mb-2">
																					<label>Jenis Lomba</label>
																					<input name="jenis" value="{{$row->jenis}}" type="text" class="form-control" required>
																				</div>
																			</div>
																			<div class="col-md-12">
																				<div class="form-floating mb-2">
																					...
																					<div class="d-flex">
																						...
																						<div class="col-md-8 p-0 mb-2">
																							<a href="{{ asset('file/Prestasi/' . $row->foto) }}">
																								<img src="{{ asset('file/Prestasi/' . $row->foto) }}" height="100px" alt="">
																							</a>
																						</div>
																					</div>
...
<script>
	...
	swal({
		title: "Yakin?",
		text: "Kamu akan menghapus data prestasi  "+jenis+" ",
		icon: "warning",
		buttons: true,
		dangerMode: true,
	})
	.then((willDelete) => {
		if (willDelete) {
			window.location = "/admin/prestasi/delete/"+prestasiid+" "
